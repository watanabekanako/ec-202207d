        ...
        <div className="container-fluid">
          ...
          >
            <p className="navbar-text navbar-right">
              <a href="cart_list.html" className="navbar-link">
                ショッピングカート
              </a>
              &nbsp;&nbsp;
            </p>
                ...
                <div className="form-group">
                  <button
                    ...
                    onClick={() => {
                      ...
                      let getPassId = document.getElementById(
                        'inputPassword'
                      ) as HTMLInputElement;
                      let getPassConfId = document.getElementById(
                      ...
                      if (
                        ...
                        if (
                          !(
                            getPassId.value.length <= 16 &&
                            getPassId.value.length >= 8
                          )
                        ) {
                          let tag = document.getElementsByClassName(
                            'control-label'
                        ...
                        if (
                          !(getPassId.value === getPassConfId.value)
                        ) {
                          let tag = document.getElementsByClassName(
                            'control-label'
                          )[6] as HTMLElement;
                        ...
                        if (
                          ...
                          const post = async () => {
                            await fetch(
                              `http://localhost:8000/users?mail=${getMailId.value}`
                            )
